The code in this folder is borrowed from the fantastic [mixxx-utils repo](https://github.com/FrankwaP/mixxx-utils/blob/main/python_tools/utils/proto/README.md)...
